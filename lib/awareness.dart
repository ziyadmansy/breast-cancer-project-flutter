          ...
          child: Column(
            children: [
                        ...
                        Row(
                          children: [
                            CircleAvatar(
                              ...
                              child: Text("BCR",style: TextStyle(color: Colors.black),),
                            ),
                            SizedBox(
                              width: 15,
                            ),
              ...
              ListTile(
                ...
                leading: Icon(Icons.account_box_sharp,color: Colors.pinkAccent,),
              ...
              ListTile(
                title: Text("Others"),
                leading: Icon(Icons.add_circle_outline_rounded,color: Colors.pinkAccent,),
